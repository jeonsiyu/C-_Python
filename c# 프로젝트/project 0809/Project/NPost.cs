        ...
        private void button_post_Click(object sender, EventArgs e)
        {
            ...
            using (OracleConnection conn = new OracleConnection(connectionString))
            {
                ...
                { 
                    ...
                    string noticeID = "공지";
                    string noticetTitle = richTextBox_Title.Text;
                    string noticeContent = richTextBox_Content.Text;
                    string noticeDate = DateTime.Now.ToString("yyyy-MM-dd");
                    string boardType = tablename(selectFilter);

                    string sql = "INSERT INTO NOTICE(noticeID, boardType, noticeTitle, noticeContent, noticeDate) " +
                                "VALUES (:noticeID, :boardType, :noticeTitle, :noticeContent, :noticeDate)";
